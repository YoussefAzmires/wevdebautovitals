...
async function getMaintenanceCollection(): Promise<Collection<MaintenanceRecord>> {
  ...
  export async function getAllMaintenanceRecord(): Promise<Array<MaintenanceRecord>>  {
    try{
      const collection = await getMaintenanceCollection();
  ...
  export async function deleteOneMaintenanceRecord(carPart: string): Promise<void | null> {
    try{
      const collection = await getMaintenanceCollection();
